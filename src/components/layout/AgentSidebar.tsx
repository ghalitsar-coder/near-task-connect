...
const NAV: NavItem[] = [
  ...
  { to: "/dashboard/workers", label: "Pekerja", icon: Users },
  { to: "/dashboard/workers/new", label: "Daftar Pekerja", icon: UserPlus },
  { to: "/dashboard/territory", label: "Peta Teritori", icon: Map },
  { to: "/dashboard/reports", label: "Laporan", icon: BarChart3 },
  { to: "/dashboard/alerts", label: "SLA Alerts", icon: AlertTriangle, badge: true },
];
